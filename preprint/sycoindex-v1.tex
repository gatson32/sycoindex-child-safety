...
% TODO: expand from methodology.html \S6 + data/leaderboard.json. Ten-model
% PAI scores, by-dimension heatmap, cross-index plot against sycophancy.

\textit{[Ten-model PAI scores and per-dimension table to come from \texttt{data/leaderboard.json}.]}
